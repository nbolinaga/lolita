...
const Footer = () => {
  return (
    <div className='relative mt-24 py-6 border-t-gray-400 border-t md:grid grid-cols-3 space-y-12 md:space-y-0 mb-20 md:mb-0 z-50'>
      ...
      <div className='md:col-span-1 md:flex justify-center items-center w-full'>
        <a href='https://forms.gle/9GzM4RFztV7ozyT17' target='_blank' className=''><h5 className='md:px-6 text-lg text-slate-800 md:mx-auto w-full text-center'>Contact Us</h5></a>
