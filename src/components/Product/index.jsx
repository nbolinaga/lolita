...
const Product = ({ imgSrc, title, text }) => {
  ...
  return (
    <div className='relative' ref={ref} onTouchStart={() => setOpen(true)} onTouchEnd={() => setOpen(false)}>
      ...
      {hovering || open && <p className='text-center absolute bottom-20 left-0 bg-[#5d6a91] text-[#fdf8f2] px-6 py-12'>{text}</p>}
